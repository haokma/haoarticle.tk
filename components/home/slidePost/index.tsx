          ...
          <div className="col-xl-12">
            <div className={styles.right}>
              ...
              <p className={styles.excerpt}>
                [Báo dantri.com.vn] Tại cuộc họp Ban Chỉ đạo quốc gia phòng chống dịch Covid-19, các
                ý kiến cho rằng, không thể đợi tiêm hết vaccine hoặc hết ca nhiễm trong cộng đồng
